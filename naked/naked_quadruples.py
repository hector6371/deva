                                        ...
                                        for fourth_candidate_col_index in range(third_candidate_col_index + 1, 9):
                                            ...
                                            if len(fourth_candidate_cell) >= 2 and (len(fourth_candidate_cell) <= 4):
                                                ...
                                                if len(four_candidates_sum_values) == 4:
                                                    ...
                                                    if util.remove_candidate_from_row(candidate_board, four_candidates_sum_values, first_candidate_row_index, exception_cols):
                                                        found_any = True
    return found_any
                                        ...
                                        for fourth_candidate_row_index in range(third_candidate_row_index + 1, 9):
                                            ...
                                            if len(fourth_candidate_cell) >= 2 and (len(fourth_candidate_cell) <= 4):
                                                ...
                                                if len(four_candidates_sum_values) == 4:
                                                    ...
                                                    if util.remove_candidate_from_col(candidate_board, four_candidates_sum_values, first_candidate_col_index, exception_rows):
                                                        found_any = True
    return found_any
